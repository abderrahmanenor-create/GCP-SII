...
"[project]/src/app/api/rh/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        const enriched = await Promise.all(users.map(async (u)=>{
            ...
            let distributions = [];
            try {
                habilitations = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].habilitation.findMany({
                    where: {
                        userId: u.id
                    },
                    include: {
                        typeHabilitation: true
                    },
                    orderBy: {
                        dateExpiration: "asc"
                    }
            ...
            try {
                distributions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].distributionEPI.findMany({
                    where: {
                        userId: u.id,
                        statut: "ACTIF"
                    },
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(enriched);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7656e02a._.js.map